/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/buildserver/coconut/openwrt-2.4.2011-trunk/build_dir/toolchain-arm_gcc-4.5.1+l_uClibc-0.9.32_eabi/gcc-linaro-4.5-2010.12-0/gcc/config/arm/arm.md'.  */
